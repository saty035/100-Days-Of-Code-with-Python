...
Label (window,image=photo1,bg='green').grid(row=0,column=0,sticky=N)  #sticky=north
...
#exit button
#submit button
Button(window,text='EXIT',width=6,command=close_window).grid(row=7,column=0,sticky=E)
